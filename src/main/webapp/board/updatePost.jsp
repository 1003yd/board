...
<%@ include file="/common/left.jsp"%> --%>
	<form action="/postUpdateServlet" method="post" id="frm" enctype="multipart/form-data">
		<span>제목</span> 
	<%-- 	<input type="hidden" name="postUser" value="${user}"> --%>
		<input type="text" id="postTitle" name="postTitle"  value="${postVo.post_title}"/>
		<input type="hidden" name="postNo" value="${postVo.post_no}">
		<input type="hidden" name="boardNo" value="${postVo.post_board}">
		<br>
		<br>
		...
		<input type="file" name="postFile" value="">
		<br> <br>
		<textarea name="smarteditor" id="smarteditor" rows="10" cols="100"
			style="width: 766px; height: 412px;">${postVo.post_context}</textarea>
