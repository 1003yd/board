...
function validation(){
	...
	if(contents === '<p>&nbsp;</p>' || contents === ''){ // 기본적으로 아무것도 입력하지R 않아도 <p>&nbsp;</p> 값이 입력되어 있음. 
		alert("내용을 입력하세요.");
...
<%@ include file="/common/left.jsp"%> --%>
	<form action="/postCommentServlet" method="post" id="frm" enctype="multipart/form-data">
		<span>제목</span> 
	<%-- 	<input type="hidden" name="postUser" value="${user}"> --%>
		<input type="text" id="postTitle" name="postTitle" />
		<input type="hidden" name="postNo" value="${postNo}"/>
		<input type="hidden" name="boardNo" value="${postBoard}"/>
		<br>
		<br>
		<div id="fileDiv">
